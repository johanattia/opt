...
class MomentumScheduledSGD(tf.keras.optimizers.Optimizer): # TODO : class docstring, __init__, _prepare_local
    ...
    def __init__(self, 
        ...
        if isinstance(momentum, (tf.Tensor, MomentumSchedule)) or callable(momentum) or momentum > 0:
            self._momentum = True
    ...
    def _set_hyper(self, name, value):
        ...
        This method is overriden to allow MomentumSchedule use for momentum hyperparameter, without loss of readability.
        """
